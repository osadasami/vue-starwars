export default class SwapiServiceDammy {
  ...
  getAllPeople = async () => {
    return this.people.map(this.transformPerson);
  };

  getPerson = async (id: number) => {
    return this.transformPerson(this.people[0]);
  };

  getAllPlanets = async () => {
    return this.planets.map(this.transformPlanet);
  };

  getPlanet = async (id: number) => {
    return this.transformPlanet(this.planets[1]);
  };

  getAllStarships = async () => {
    return this.starships.map(this.transformStarship);
  };

  getStarship = async (id: number) => {
    return this.transformStarship(this.starships[0]);
  };
